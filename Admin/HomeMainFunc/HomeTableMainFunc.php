...
<body><br>
<button type="button" class="btn btn-primary mr-2" style="" onclick="window.location.href='requestList.php'">Request List</button>
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                elseif ($dateDiffDays > 0 &&  $row['request_room'] == $room && $row['req_starttime'] == $startTime && $row['req_endtime'] == $endTime) {
                                                 ...
                                                 if($dateDiffDays > 0 && $hallow) {
                                                        ...
                                                        echo "<button class='statusAvaiBut redbut' title=' $titleContent' style='background-color: $backgroundColor;margin:0;display:inline;'>$displayText</button>";
