    ...
    <div class="col-lg-6">
		<div class="jumbotron">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-5">
				  <input id="starttime" name="starttime" type="time" placeholder="" class="form-control input-md" required="">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-5">
				  <input id="endtime" name="endtime" type="time" placeholder="" class="form-control input-md" required="">
