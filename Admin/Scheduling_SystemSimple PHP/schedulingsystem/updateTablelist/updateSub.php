...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE table_sched SET subject = ? WHERE id = ?";
    ...
    if(mysqli_stmt_execute($stmt)) {
       ...
       header('Location: ../tablelist.php'); // Redirect to tablelist.php
        ...
        echo "Error updating Subject name: " . mysqli_error($link);
    }
    ...
    <div class="form-container">
        <form action="" method="POST">
            ...
            <div class="form-group">
                <label for="name">Update Subject Name</label><br>
                <select name="name" id="name">
                    ...
                    if(isset($_GET["id"]) && !empty($_GET["id"])) {
                        ...
                        $query = "SELECT subject_description FROM subject ORDER BY subject_description";
